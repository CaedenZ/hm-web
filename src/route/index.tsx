...
import PayrollFileLogPage from "../scenes/CompensationSetup/PayrollUploadPage/filelog";
      ...
      return (
        <ConnectedRouter history={history}>
          <Switch>
            ...
            <Route
              exact
              path="/marketdataupload/upload"
              render={() => (
                <PrimaryLayout>
                  <MarketFileUploadPage />
                </PrimaryLayout>
              )}
            />
            ...
            <Route
              exact
              path="/marketdataupload/upload/log"
              render={(props) => (
                <PrimaryLayout>
