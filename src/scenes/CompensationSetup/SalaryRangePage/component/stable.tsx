    ...
    render() {
      ...
      return (
        <Paper className={classes.root}>
            <GridComponent dataSource={this.props.salaryrangeList} toolbar={this.toolbarOptions} editSettings={this.editSettings} ref={ grid => this.gridInstance = grid} allowGrouping={true} groupSettings={this.groupOptions} allowSorting={true}
