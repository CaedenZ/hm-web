...
export class CustomizedTable_v2 extends React.Component<Props, State>  {
    ...
    state = {
      ...
      actionBegin(args: any): void {
        ...
        //var newjobgrade = this.gridInstance.dataSource; 
        //this.props.deleteJobGrade(newjobgrade);
        //const obj: Object[] = this.gridInstance.getSelectedRecords();
        //console.log(obj);
        //const rowIndexes : string[]=[];
        //obj.forEach((dat: any,index) => {
    ...
    render() {
      ...
      return (
        <Paper className={classes.root}>
            <GridComponent dataSource={this.props.jobgradeList} toolbar={this.toolbarOptions} editSettings={this.editSettings} allowPaging={true} ref={ grid => this.gridInstance = grid} pageSettings={{ pageCount: 5 }} allowGrouping={true} groupSettings={this.groupOptions} allowSorting={true}
