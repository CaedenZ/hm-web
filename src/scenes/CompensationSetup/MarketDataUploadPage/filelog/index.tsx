...
class FileLogPageMarket extends React.Component<Props, State> {
  state: State = {
    data: false,
    listqueuelog: [],
    file: ""
...
(FileLogPageMarket as React.ComponentClass<Props>).propTypes = {
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(withStyles(styles)(FileLogPageMarket));
