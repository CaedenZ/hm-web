  ...
  render() {
    ...
    return (
      <div className={classes.root}>
        ...
        <FormPage create={true} updateData='' onSubmit={(e, data) => this.handleCreateSignons(e, data)} />
      </div>
    );
  }
}

export default connect(null, mapDispatchToProps)(withStyles(styles)(CreateSignonsPage));
