    ...
    render() {
      ...
      return (
        <Paper className={classes.root}>
            <GridComponent dataSource={this.props.signonsList} toolbar={this.toolbarOptions} editSettings={this.editSettings} allowPaging={true} ref={ grid => this.gridInstance = grid} pageSettings={{ pageCount: 5 }} allowSorting={true}
