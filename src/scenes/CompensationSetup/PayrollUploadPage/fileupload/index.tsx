...
class FileUploadPage extends React.Component<Props, State> {
  ...
  listqueue = async () => {
    ...
    this.state.raw_listqueue.forEach(element => {
      ...
      this.state.format_listqueue.push({ source_filepath: element.source_filepath, uploaded: date, status: this.getstatus(element.status), active: this.getactive(element.active), original_filename: element.original_filename })
    });
          ...
          <Paper className={classes.root}>
            <GridComponent dataSource={this.state.format_listqueue} editSettings={this.editOptions} allowSorting={true} allowTextWrap={true}
              ...
              <ColumnsDirective>
                ...
                <ColumnDirective field='original_filename' allowEditing={false} headerText='File' textAlign='Left'></ColumnDirective>
