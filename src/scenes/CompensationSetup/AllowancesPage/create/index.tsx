  ...
  render() {
    ...
    return (
      <div className={classes.root}>
        ...
        <FormPage create={true} updateData='' onSubmit={(e, data) => this.handleCreateAllowances(e, data)} />
      </div>
    );
  }
}

export default connect(null, mapDispatchToProps)(withStyles(styles)(CreateAllowancesPage));
