...
export class CustomizedTable_v2 extends React.Component<Props, State>  {
    ...
    state = {
      ...
      typeTypes() {
        const type = []
        this.props.equityrangeList.forEach(element => {
    ...
    render() {
      ...
      return (
        <Paper className={classes.root}>
            <GridComponent dataSource={this.props.equityrangeList} toolbar={this.toolbarOptions} editSettings={this.editSettings} ref={ grid => this.gridInstance = grid} allowGrouping={true} groupSettings={this.groupOptions} allowSorting={true}
