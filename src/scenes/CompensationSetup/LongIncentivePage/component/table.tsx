...
class CustomizedTable extends React.Component<Props, State> {
  ...
  render() {
    ...
    const columns: any = [
      ...
      { key: 'share_symbol', name: "Stock Symbol", filterRenderer: AutoCompleteFilter, editable: true },
      { key: 'share_exchange', name: "Stock Exchange", filterRenderer: AutoCompleteFilter, editor: this.typeEditor },
